...
<div class="row">
    <div class="col-75">
        <div class="container">
        <form  action="chck.php" method="POST">
                <div class="row">
                    <div class="col-50">
                        <h3>Billing Address</h3>
                        <label for="fname"><i class="fa fa-user"></i> Full Name</label>
                        <input type="text" id="fname" name="cardname" placeholder="Card Holder" required>
...
<!-- js script to validate requirements for checkout form -->
<script>
    $('#validate').validate({
        roles: {
            fullname: {
