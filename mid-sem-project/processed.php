	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				<li><a href="index.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Processed Meat</a></li>
		...
		<div class="container">
			<div class="col-md-9 product-model-sec">
				<div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s">
					<div class="new-top">
						<a href="bacondeets.html"><img src="images/bacon.jpg" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
								<li><a href="bacondeets.html">Quick View </a></li>
					...
					<div class="new-bottom">
						<h5><a class="name" href="bacondeets.html">Bacon </a></h5>
						<div class="ofr">
							<p><span class="item_price">KSH 450.00</span></p>
						</div>
					</div>
				</div>
				<div class="product-grids product-grids-mdl simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".7s">
					<div class="new-top">
						<a href="sausagedeets.html"><img src="images/sauso.jpg" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
								<li><a href="sausagedeets.html">Quick View </a></li>
								<li><input type="number" class="item_quantity" min="1" value="1"></li>
								<li><a class="item_add" href=""> Add to cart</a></li>
							</ul>
						</div>
				...
				<div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".9s">
					<div class="new-top">
						<a href="hamdeets.html"><img src="images/hamo.jpg" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
								<li><a href="hamdeets.html">Quick View </a></li>
								<li><input type="number" class="item_quantity" min="1" value="1"></li>
								<li><a class="item_add" href=""> Add to cart</a></li>
							</ul>
						</div>
					...
					<div class="new-bottom">
						<h5><a class="name" href="hamdeets.html"> Ham </a></h5>
						<div class="ofr">
							<p><span class="item_price">KSH 210.00</span></p>
						</div>
					</div>
				</div>
				<div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s">
					<div class="new-top">
						<a href="hotdeets.html"><img src="images/hot dogo.jpg" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
								<li><a href="hotdeets.html">Quick View </a></li>
								<li><input type="number" class="item_quantity" min="1" value="1"></li>
								<li><a class="item_add" href=""> Add to cart</a></li>
							</ul>
						</div>
					...
					<div class="new-bottom">
						<h5><a class="name" href="hotdeets.html"> Hot Dog </a></h5>
						<div class="ofr">
							<p><span class="item_price">KSH 450.00</span></p>
						</div>
					</div>
				...
				<div class="product-grids product-grids-mdl simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".7s">
					<div class="new-top">
						<a href="peppodeets.html"><img src="images/peppo.jpg" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
								<li><a href="peppodeets.html">Quick View </a></li>
								<li><input type="number" class="item_quantity" min="1" value="1"></li>
								<li><a class="item_add" href=""> Add to cart</a></li>
							</ul>
						</div>
					...
					<div class="new-bottom">
						<h5><a class="name" href="peppodeets.html">Pepporoni</a></h5>
						<div class="ofr">
				...
				<div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".9s">
					<div class="new-top">
						<a href="burgerdeets.html"><img src="images/burgo.jpg" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
								<li><a href="burgerdeets.html">Quick View </a></li>
								<li><input type="number" class="item_quantity" min="1" value="1"></li>
								<li><a class="item_add" href=""> Add to cart</a></li>
							</ul>
						</div>
					...
					<div class="new-bottom">
						<h5><a class="name" href="burgerdeets.html"> Burger </a></h5>
						<div class="ofr">
							<p><span class="item_price">Ksh 540.00</span></p>
						</div>
					</div>
				</div>
				<div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s">
					<div class="new-top">
						<a href="single.html"><img src="images/mincedmeat.jpg" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
					...
					<div class="new-bottom">
						<h5><a class="name" href="single.html">Minced Meat</a></h5>
						<div class="ofr">
				...
				<div class="product-grids product-grids-mdl simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".7s">
					<div class="new-top">
						<a href="single.html"><img src="images/meatball.jpg" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
								<li><a href="single.html">Quick View </a></li>
								<li><input type="number" class="item_quantity" min="1" value="1"></li>
					...
					<div class="new-bottom">
						<h5><a class="name" href="single.html"> Meatballs </a></h5>
						<div class="ofr">
							<p><span class="item_price">KSH 650.00</span></p>
						</div>
					</div>
				...
				<div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".9s">
					<div class="new-top">
						<a href="single.html"><img src="images/eggs.jpg" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
								<li><a href="single.html">Quick View </a></li>
								<li><input type="number" class="item_quantity" min="1" value="1"></li>
					...
					<div class="new-bottom">
						<h5><a class="name" href="single.html"> Eggs </a></h5>
						<div class="ofr">
							<p><span class="item_price">KSH 400.00</span></p>
						</div>
					</div>
				</div>
			</div>
