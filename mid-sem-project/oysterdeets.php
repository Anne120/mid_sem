...
<html>
<head>
<title>Meaty Meats | Product Description</title>
		...
		<div class="top-header navbar navbar-default">
			<div class="container">
				<div class="nav navbar-nav wow fadeInLeft animated" data-wow-delay=".5s">
					<p>Welcome to Meaty Meats <a href="register.html">Register </a> Or <a href="signin.html">Sign In </a></p>
				</div>
			</div>
		</div>
		<div class="header-two navbar navbar-default">
			<div class="container">
				<div class="nav navbar-nav header-two-left">
					<ul>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+60 1-2345 6789</li>
				...
				<nav class="navbar" role="navigation">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav top-nav-info">
							...
							<li>
								<a href="processed.php"><b>Processed Food</b></a>
							</li>
						</ul> 
						<div class="clearfix"> </div>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Product Descreption</li>
			</ol>
		</div>
	</div>
	<div class="single">
		<div class="container">
			<div class="single-info">
				...
				<a href="#"><img src="images/oysti.jpg" class="img-responsive" alt=""/></a>
					<h3> Oyster </h3><br>
					<h6 class="item_price">KSH 1500.00</h6>			
					<p>Our Oysters are probably the ones you’ve enjoyed if you live in Kenya, and you frequent a Raw Bar. 
						Medium-sized, they are mild, pleasingly salty and extremely meaty.</p>
					<ul class="weight">
						<h4> Weight </h4>
						<li><a href="#"> 500g </a></li>
						<li><a href="#"> 1 kg</a></li>
						<li><a href="#"> 1.5kg </a></li>
						<li><a href="#"> 2 kg</a></li>
					</ul>
					<div class="clearfix"> </div>
					<div class="quantity">
					...
					<div class="panel panel-default wow fadeInUp animated" data-wow-delay=".5s">
						...
						<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
							<div class="panel-body">
								The tiny Kumamoto Oyster is deep-cupped, concealing a flavor that most West Coasters describe as a salted cucumber.
								 This is a crisp-tasting oyster that both aficionados and first-timers will enjoy.
							</div>
						</div>
					</div>
							...
							<h4 class="panel-title">
								...
								<!-- Begin form, and specify where it’s going to send our data and how. -->
									<form action="URL_OF_OUR_PROCESSING_SCRIPT.PHP" method="post" name="form">
										...
										<br>
										<textarea cols="32" name="message" rows="5">How would you rate the purchased cut?</textarea>
										<br>
										
										<!--Let’s add a button that submits this form to the db-->
										...
										<!--php logic-->
										<?php
										// Time to get the variables from the user’s request. Once we execute these four commands, 
										//we’ll have the user’s data in our variables.
										$name = $_POST['name'];
										$email = $_POST['email'];
										$header = $_POST['header'];
								...
								<!--<script type="text/javascript">
										(function(){var id="uLFEhbbF5IYPQtywH4qd0FVNkxhAARduku8auh84";
										var js=document.createElement("script");
										js.setAttribute("type","text/javascript");
										js.setAttribute("src","//deploy.mopinion.com/js/pastease.js");
										js.async=true;document.getElementsByTagName("head")[0].appendChild(js);
										var t=setInterval(function(){try{Pastease.load(id);
		...
		<div class="container">
			<div class="footer-info">
				<div class="col-md-4 footer-grids wow fadeInUp animated" data-wow-delay=".5s">
					...
					<p>2021 © Meaty Meats. All rights reserved | Curated by 658308</p>
				</div>
