...
<html>
<head>
<title>Nyama Nyama | Feedback</title>
...
<body class="agileits_w3layouts">
    <h1 class="agile_head text-center">Nyama Nyama Feedback</h1>
    <div class="w3layouts_main wrap">
	  <h3>Please help us to serve you better 🤗 </h3>
	    <form action="feedback.php" method="post" class="agile_form">
		  <h2>How satisfied were you with the cuts you purchased?</h2>
